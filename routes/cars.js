...
import { createCar, getCars, addViolation, getSafeList,resetViolation,verify, deleteCar,getCar,safe, violationList, safeList, updateVerify, updateSafeStatus,deleteCars,BulkCars, findCars, getCollection, removeViolation, updateSchema, addCarImage,switchAutoTow,reGetCar } from "../controllers/cars.js"

const router = express.Router()

router.get('/',getCars)
router.get('/find/:id',getCar)
router.get('/refind/:id',reGetCar)
...
router.patch('/autoTow/:id',switchAutoTow)
